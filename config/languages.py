...
LANGUAGES = {
    'zh': {
        ...
        'no_file_msg': '👈 请在左侧上传 JSON 配置文件或输入文件夹路径开始使用',
        'json_example_title': '📄 查看 JSON 格式示例',
        'input_mode_label': '输入模式',
        'input_mode_json': 'JSON 配置文件',
        'input_mode_paths': '文件夹路径列表',
        'path_list_label': '输入文件夹路径',
        'path_list_help': '每行输入一个文件夹路径，第一个路径用于扫描图片文件',
        'path_list_placeholder': '输入文件夹路径，每行一个\n例如:\n/path/to/method1/images\n/path/to/method2/images',
        'load_paths_button': '加载路径',
        'path_list_example_title': '📁 路径列表格式说明',
    ...
    'en': {
        ...
        'no_file_msg': '👈 Please upload a JSON configuration file or enter folder paths in the sidebar',
        'json_example_title': '📄 View JSON Format Example',
        'input_mode_label': 'Input Mode',
        'input_mode_json': 'JSON Configuration',
        'input_mode_paths': 'Folder Path List',
        'path_list_label': 'Enter Folder Paths',
        'path_list_help': 'Enter one folder path per line, the first path will be scanned for images',
        'path_list_placeholder': 'Enter folder paths, one per line\nExample:\n/path/to/method1/images\n/path/to/method2/images',
        'load_paths_button': 'Load Paths',
        'path_list_example_title': '📁 Path List Format',
